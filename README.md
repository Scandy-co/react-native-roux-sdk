...
Sets whether this device should send commands to connected scanning devices. If enabled = `treu`, calls to functions `startScan`, `stopScan`, `generateMesh`, and `setSize` will be sent to the connected scanning device.
